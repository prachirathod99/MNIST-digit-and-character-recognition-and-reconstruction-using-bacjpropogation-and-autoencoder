...
train_data_1 = load('EMNISTletterstraindata.txt');   
train_label = load('EMNISTtrainlabels.txt');
test_data_1 = load('EMNISTletterstestdata.txt');
test_label = load('EMNISTtestlabels.txt');
...
% Code reference: Dr. Ali Minai's code 
figure(5)
P1 = load('Part1Input_weights.txt');
