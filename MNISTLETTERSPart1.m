...
imgage_data = load('EMNISTlettersdataset.txt'); %loads the image data
image_label = load('EMNISTdatasetLabels5000.txt'); %loads the labels
...
confusion_train_matrix(1:26,1:26) = (0);                
confusion_test_matrix(1:26,1:26) = (0);  

%spliting the datat into test and train
train_data_1 = random_order_data(1:4000,:);
train_lab = random_order_lab(1:4000,:);
test_data_1 = random_order_data(4001:5000,:);
test_lab = random_order_lab(4001:5000,:);

train_data = train_data_1/256;
test_data = test_data_1/256;

%saving the data

dlmwrite('EMNISTletterstraindata.txt', train_data);
dlmwrite('EMNISTletterstestdata.txt', test_data);
dlmwrite('EMNISTtrainlabels.txt', train_lab);
dlmwrite('EMNISTtestlabels.txt', test_lab);
...
dlmwrite('Part1Input_weights.txt', weight_input);
dlmwrite('Part1Output_weights.txt', weight_output);
